# VizChemLab — Визуальная Химическая Лаборатория
...
- **Симулятор химических реакций**: Генерация и уравнивание химических уравнений с использованием локальной языковой модели (Ollama/Phi3).
